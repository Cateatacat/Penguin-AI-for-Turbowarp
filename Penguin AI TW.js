...
// Fixed for TurboWarp by bambus80
...
(function (Scratch) {
  ...
  // Initialize the api_url variable with a default value (changed it to the new one)
  let api_url = "https://proxy.mubilop.tech/v1";
  const vm = Scratch.vm;
  class PenguinGPT {
    constructor() {
      // thank u Ashime for helping me here!!!
      this.chatHistories = {};
      this.model = "gpt-4o";
      this.reqModels = [
        {
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          // removed due to not cooperating with TW (bad boy >:c)
          // edit: unfixed it! :3
          {
            opcode: "setModel",
            blockType: Scratch.BlockType.COMMAND,
